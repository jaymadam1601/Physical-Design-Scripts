...
proc timing_slack_check_sp_ep {file_name {input_type "pins"} {result_file "setup_hold_margin_check.rpt"}} {
	...
	while {[gets $fp line] >= 0} {
		...
		puts $fp1 "$start_point $end_point $top_slack $setup_slack" 
	}
...
puts "Usage:"
puts "timing_slack_check_sp_ep <sp_ep_file> <sp_ep_type cells/pins default:pins> <output_file optinal>"
