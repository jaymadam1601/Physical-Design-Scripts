...
proc check_inout_add_buffer {insert_buffer_ref_name} {
	set fp [open "eco_add_buffer.tcl" w]
	deselectAll
	selectInst [dbget top.insts.name GFIX_DMSA_20252305_PTECO_HOLD_BUF*]
	selectInst [dbget top.insts.name GFIX_DMSA_20250904_PTECO_HOLD_BUF*]
	set cell_names [dbget selected.name]
	deselectAll
...
proc add_buffer_in_out {cell_name insert_buffer_ref_name} {
	set fanin_level_1_cell [level_1_fanin_cell $cell_name]
    set fanin_level_1_net  [level_1_fanin_net $cell_name]
	puts "ecoAddRepeater -cell $insert_buffer_ref_name -net $fanin_level_1_net -loc \"[get_mid_point_of_cells $cell_name $fanin_level_1_cell]\""
	set fanout_level_1_cell [level_1_fanout_cell $cell_name]
	set fanout_level_1_net  [level_1_fanout_net $cell_name]
	set fanout_level_1_cell_boxll [dbget [dbget top.insts.name place_FE_OFC98699_lpcr_top_msb_0__agPORTISO -p ].box_ll]
	puts "ecoAddRepeater -cell $insert_buffer_ref_name -net $fanout_level_1_net loc $fanout_level_1_cell_boxll"
}
